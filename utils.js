...
// Vi använder lokala konstanter istället för extern config
const gameWidth = 5000;
const gameHeight = 5000;

export const validNick = function (nickname) {
    var regex = /^\w*$/;
    return regex.exec(nickname) !== null;
};

// determine mass from radius of circle
export const massToRadius = function (mass) {
    return 4 + Math.sqrt(mass) * 6;
};


// overwrite Math.log function
export const mathLog = (function () {
    var log = Math.log;
...
export const randomInRange = function (from, to) {
    return Math.floor(Math.random() * (to - from)) + from;
};

// generate a random position within the field of play
export const randomPosition = function (radius) {
    return {
...
export const uniformPosition = function (points, radius) {
...
export const removeNulls = function (inputArray) {
    let result = [];
...
export const removeIndexes = function (inputArray, indexes) {
...
export const testRectangleRectangle =
...
export const testSquareRectangle =
...
export const getIndexes = (array, predicate) => {
