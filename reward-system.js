...
const RewardSecurityAlertSchema = new mongoose.Schema({
    ...
    snapshots: [{
        ...
        freeTicketChallengeCompleted: Boolean,
        freeTicketChallengeCompletedAt: Date,
...
async function restoreSharedWalletSnapshot(User, alert, snapshot) {
    ...
    await User.updateOne(
        ...
        { $set: {
            ...
            freeTicketChallengeCompleted: snapshot.freeTicketChallengeCompleted,
            freeTicketChallengeCompletedAt: snapshot.freeTicketChallengeCompletedAt,
